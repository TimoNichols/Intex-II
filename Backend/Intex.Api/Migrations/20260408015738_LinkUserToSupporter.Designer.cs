...
namespace Intex.Api.Migrations
{
    ...
    [Migration("20260408015738_LinkUserToSupporter")]
    partial class LinkUserToSupporter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intex.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Intex.Api.Models.SocialMediaPost", b =>
                {
                    ...
                    b.ToTable("social_media_posts", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Intex.Api.Models.ApplicationUser", null)
                        .WithMany()
